# -*- coding: utf-8 -*-
"""
Created on Tue Nov 24 04:44:25 2020
...
#%%movie of microscopic vectors
VectorMovie(Vecx17,x17[1],None)
#%%visualisation of changing pixelated vectors
VectorMovie(VectorPixels[0],VectorPixels[1],None)
#%%obtaining frame at t=10 of pixelated vectors
VectorMovie(VectorPixels[0],VectorPixels[1],16)
#%%plotting the specified frame of divergence
DivMovie(VectorPixels[0],VectorPixels[1],16)   
#%%movie of divergence
DivMovie(VectorPixels[0],VectorPixels[1],None)
#%%ignore this
# the following sets a 'history' in each time frame of the vectors
# to check whether it calculates more accurately divergence
#for time in range(len(VectorPixels[0])):
#    for cell in range(len(VectorPixels[0][time])):
#        if VectorPixels[0][time][cell]==[0,0] and time!=0:
#            VectorPixels[0][time][cell]=VectorPixels[0][time-1][cell]